...
type Client struct {
	...
	seq      int64
	pending  map[int64]*Call //存储未完成的call
...
func (client *Client) registerCall(call *Call) (int64, error) {
	client.mu.Lock()
...
func (client *Client) removeCall(seq int64) *Call {
	client.mu.Lock()
	defer client.mu.Unlock()
